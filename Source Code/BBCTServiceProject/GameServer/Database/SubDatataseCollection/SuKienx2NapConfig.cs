...
{
    public class SuKienx2NapConfig : AbsCollectionController<MSKx2NapConfig>
    {
        public SuKienx2NapConfig(string nameCollection, IMongoDatabase database)
            : base(nameCollection, database)
        {
            DBHandler.CreateIndexServerData(Collection);
        }

        public MSKx2NapConfig GetData()
        {
