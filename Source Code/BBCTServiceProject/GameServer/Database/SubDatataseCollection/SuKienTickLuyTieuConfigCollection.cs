...
{
    public class SuKienTickLuyTieuConfigCollection : AbsCollectionController<MSKTichLuyTieuConfig>
    {
        public SuKienTickLuyTieuConfigCollection(string nameCollection, IMongoDatabase database)
            : base(nameCollection, database)
        {
            DBHandler.CreateIndexServerData(Collection);
        }

        public MSKTichLuyTieuConfig GetData()
        {
