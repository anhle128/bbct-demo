...
{
    public class SuKienThanTaiConfigCollection : AbsCollectionController<MSKThanTaiConfig>
    {
        public SuKienThanTaiConfigCollection(string nameCollection, IMongoDatabase database)
            : base(nameCollection, database)
        {
            DBHandler.CreateIndexServerData(Collection);
        }

        public MSKThanTaiConfig GetData()
        {
